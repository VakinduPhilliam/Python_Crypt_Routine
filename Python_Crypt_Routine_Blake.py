...
# Simple hashing
# To calculate hash of some data, you should first construct a hash object by calling the appropriate constructor function (blake2b()
# or blake2s()), then update it with the data by calling update() on the object, and, finally, get the digest out of the object by
# calling digest() (or hexdigest() for hex-encoded string).
